...
namespace rapid_docs_models.Migrations
{
    ...
    [Migration("20220905150747_IsSigningCompletedField")]
    partial class IsSigningCompletedField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CompanyLogoExtension")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("CompanyLogoGuid")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.Survey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyFormPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SurveyFormPages");
                });

            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyInputField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("SurveyFormPageId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SurveyFormPageId");

                    b.ToTable("SurveyInputFields");
                });

            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyInputOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("SurveyInputFieldId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SurveyInputFieldId");

                    b.ToTable("SurveyInputOptions");
                });

            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyRecipientMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SurveyRecipientMappings");
                });
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.Signing", b =>
                {
                    b.HasOne("rapid_docs_models.DbModels.Company", null)
                        .WithMany("Signings")
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.Survey", b =>
                {
                    b.HasOne("rapid_docs_models.DbModels.SurveyForm", "SurveyForm")
                        .WithMany()
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyFormPage", b =>
                {
                    b.HasOne("rapid_docs_models.DbModels.SurveyForm", null)
                        .WithMany("SurveyFormPages")
                        .HasForeignKey("SurveyFormId");
                });

            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyInputField", b =>
                {
                    b.HasOne("rapid_docs_models.DbModels.SurveyFormPage", null)
                        .WithMany("InputFields")
                        .HasForeignKey("SurveyFormPageId");
                });

            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyInputOption", b =>
                {
                    b.HasOne("rapid_docs_models.DbModels.SurveyInputField", null)
                        .WithMany("Options")
                        .HasForeignKey("SurveyInputFieldId");
                });

            modelBuilder.Entity("rapid_docs_models.DbModels.SurveyRecipientMapping", b =>
                {
                    b.HasOne("rapid_docs_models.DbModels.Survey", "Survey")
                        .WithMany()
            ...
            modelBuilder.Entity("rapid_docs_models.DbModels.User", b =>
                {
                    b.HasOne("rapid_docs_models.DbModels.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId");
